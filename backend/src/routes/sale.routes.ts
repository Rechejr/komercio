...
router.post('/',
  ...
  [
    ...
    body('customerId').optional({ nullable: true }).isUUID().withMessage('customerId inválido'),
    body('branchId').optional({ nullable: true }).isUUID().withMessage('branchId inválido'),
  ],
  validate,
